...
export default function LoginPage() {
  ...
  return (
    <main className="relative min-h-screen flex items-center justify-center p-4">
      ...
      >
        {/* Card */}
        <div className="relative glass-card rounded-2xl p-8 border border-neon-cyan/30 overflow-hidden">
          {/* Holographic overlay */}
          ...
          <div className="relative z-10">
            ...
            <Link href="/" className="flex items-center justify-center gap-2 mb-8">
              ...
              >
                ...
                <div className="absolute inset-0 blur-lg bg-neon-cyan/50 rounded-full" />
              </motion.div>
              <span className="text-2xl font-bold text-neon-cyan text-glow-cyan font-[family-name:var(--font-orbitron)]">
                SENTINALPAY
              </span>
            </Link>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    type="checkbox"
                    className="w-4 h-4 rounded border-border bg-card accent-neon-cyan"
                  />
